...
function ProductList({ onHomeClick }) {
  ...
  const alreadyAdded = (plant) => {

    const added = CartItems.find((item) => item.name === plant.name);
    if (added) {
      return true;
    } else {
      return false;
                  ...
                  {category.plants.map(
                    (
                      ...
                      <div className="product-card" key={plantIndex}>
                        ...
                        {/* Display plant cost */}
                        <button
                          className="product-button" // Deja solo tu clase base aquí
                          disabled={alreadyAdded(plant)} // React bloquea el botón si esto es true
